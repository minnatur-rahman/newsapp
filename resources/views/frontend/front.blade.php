          ...
          <div class="col-md-7 collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div  class="col-xs-12 col-md-1 col-sm-12">
                ...
                <ul class="dropdown-menu" aria-labelledby="socialDropdown">
                    <li><a class="dropdown-item" href="{{ $social->facebook }}" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i>Facebook</a></li>
                    <li><a class="dropdown-item" href="{{ $social->twitter }}" target="_blank">Twitter</a></li>
                    <li><a class="dropdown-item" href="{{ $social->instagram }}" target="_blank">Instagram</a></li>
                    <li><a class="dropdown-item" href="{{ $social->linkedin }}" target="_blank">LinkedIn</a></li>
                    <li><a class="dropdown-item" href="{{ $social->youtube }}" target="_blank">YouTube</a></li>
                </ul>
            </div>
          </div>
        </div>
